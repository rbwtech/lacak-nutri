...
class EducationArticle(Base):
    ...
    is_published = Column(Integer, default=1) # Boolean 1/0
...
class NutritionInfo(Base):
    ...
    category = Column(String(50)) # makro/mikro
    unit = Column(String(20))
    daily_value = Column(Integer) # Decimal di DB, float/int di sini
...
class Additive(Base):
    ...
    category = Column(String(50)) # pemanis, pengawet, dll
